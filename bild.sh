...
info "Symlinking $(bold $NGINX_CONF_FILE) to $(bold "/etc/nginx/sites-enabled/$DOMAIN_NAME")"
# ln -s $NGINX_CONF_FILE /etc/nginx/sites-enabled/$DOMAIN_NAME

# FIXME: Ask first (certs might already be installed)
